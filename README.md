...
Sample python code you can use / copy into your own projects to read and control the router (DISCHARGE, CHARGE, HOLD). I use this in Sydney against my electricty provider (Amber) who offer the wholesale rate, so I basically code CHARGES and DISCHARGES based on the battery "state of charge", cost price / feed in price, time of day, predicted evening peak. At this stage I only upload basic control code as I actually found this to be the hardest part of the project! Also callout to https://github.com/matus-markusek/homeassistant-solplanet who offer a great home assistant integration (which might suit more people), but code below might suit people who want to code outside of the Home Assistant eco system...
